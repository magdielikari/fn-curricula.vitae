...
class Hobby extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Hobbies::className(), ['hobby_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Flavor::className(), ['id' => 'flavor_id'])->viaTable('hobbies', ['hobby_id' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\query\HobbyQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\HobbyQuery(get_called_class());
    }
}
