...
/**
 * StylesheetsSearch represents the model behind the search form about `app\models\Stylesheets`.
 */
class StylesheetsSearch extends Stylesheets
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])
            ...
            ->andFilterWhere(['like', 'photo_contact_style', $this->photo_contact_style])
            ...
            ->andFilterWhere(['like', 'description_additional_style', $this->description_additional_style])
            ...
            ->andFilterWhere(['like', 'item_experience_style', $this->item_experience_style])
            ...
            ->andFilterWhere(['like', 'item_academic_style', $this->item_academic_style])
