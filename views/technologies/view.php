...
<div class="technologies-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'flavor_id' => $model->flavor_id, 'technology_id' => $model->technology_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'flavor_id' => $model->flavor_id, 'technology_id' => $model->technology_id], [
