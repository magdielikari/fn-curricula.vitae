...
<div class="academics-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'academic_id' => $model->academic_id, 'flavor_id' => $model->flavor_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'academic_id' => $model->academic_id, 'flavor_id' => $model->flavor_id], [
