...
<div class="hobbies-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'flavor_id' => $model->flavor_id, 'hobby_id' => $model->hobby_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'flavor_id' => $model->flavor_id, 'hobby_id' => $model->hobby_id], [
